...
| Name                          | IS| UP| Cost
//------------------------------|---|---|-----------
| Adventurer's Logbook          | 1 | 10| 20 gp
...
resistant to fire, water, and wear and tear. An adventurer use this book to
take notes on their adventures. The writings in this book can be easily and
magically transferred to other books.
...
which is only available to heroes and elites. If you are not buried or 
