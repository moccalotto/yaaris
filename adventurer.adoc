...
NOTE: If the target number is 10, you must roll __below__ 10, not equal to 10,
to
succeed,
...
=== Money
A gold piece (__gp__) is equivalent to 100 silver pieces (__sp__), a silver
piece is 100 copper pieces (__cp__).
...
__constitution__, and if your constitution changes, so does the number
of item slots you can carry. You can use up all your item slots without any
side effects, but can carry up to __strength__ additional item slots by
overburdening yourself and being <<encumbered>> while doing so.
...
| Name                          | {IS} | {UP} | {cost}
//------------------------------|------|------|------
| Dagger __(melee & thrown)__   |   1  |  1   | 3  gp
| Javelin __(melee & thrown)__  |   1  |  1   | 3  gp
| Axe __(melee & thrown)__      |   1  |  1   | 3  gp
| Dart                          |   1  |  4   | 3  gp
| Bow                           |   2  |  -   | 7  gp
...
.Move economy
****
Moves do not __carry over__; use them or lose them, they're gone when you take
<<Actions,action>> or the round ends.
...
|===
//----------|-------------------------------------
| {twenty}  | You miss and your weapon <<damaged_weapon,takes damage>>.
...
//KEY:
[[exhausted,exhausted]]
*Exhausted*: You are <<encumbered>> __and__ your number of <<moves>> is halved,
rounded down.
...
//KEY:
*Unskilled (armor)*: When you are not skilled at using a piece of armor you
lose one <<moves,move>>.
