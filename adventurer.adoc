...
Your starting stats range from 8 through 13 and may improve as you level up,
but they can never increase beyond 15.
...
as you level up, and also when you're wearing armor.
...
==== Vice
Roll a d12 to find out what kind of vice (if any) you have.
...
<<adventurers_blessing>>. Roll a d6 and a d20. If the d6 rolled an odd number,
...
[quote]
Notify the GM when making checks that you think could be helped by your
...
*CONCRETE EXAMPLE*:
You want to lift a heavy strongbox, so the GM tells you to make a
