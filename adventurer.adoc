...
* They are almost immune to mental health problems such as addiction, anxiety,
...
former adventurers of high levels in key military and governing positions, as
the ability to be revived can be, well, vital for the continuation of such
position.
...
*Acquire*:
You have __acquired__ a treasure when you have transported at least two thirds of
...
__strength__ check. You roll a d20. If you rolled lower than your __strength__, the
...
[example]
if your __strength__ is 9, making a difficult __strength__ check would need to roll
under 6.
...
spend 10 minutes and one <<consumption_check,consumption>> of __tinkering
tools__. Then you make a __dexterity__ check and an __intelligence__ check.
...
attack, you make an <<adversarial>> __wisdom__ check, and if you're making
...
it reduces your number of <<Moves,moves>> by one. This is cumulative so if
...
__dexterity__ or __constitution__ (your choice) if you succeed, you only lose half
...
Procedure::
* Make an __intelligence__ check:
...
[[quote]] It can be advantageous to keep you and your party's items away from
you while you're using this spell.
...
If the spell didn't fizzle, you may make another __charisma__ check, and if it
