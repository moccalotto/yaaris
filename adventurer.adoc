...
<1> Most light melee weapons are one-handed, with notable exceptions such as
the quarterstaff.
<2> Throwing-weapons can often be used as light melee weapons (such as daggers,
...
<3> Heavy melee weapons always require two hands, and can never be used as
throwing weapons.
--
...
| 90-98     | Reversible | -1 <<Moves,moves>>
...
<<restoration_salve,restoration salves>> or by using high-level
<<restoration_magic>>.
