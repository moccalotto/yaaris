...
with <<Illuminate (X)>> cast on it. The item must be within _wisdom_ meters. To
you, magical items start to glow after you've looked directly at them for a
while. You need to take things slow if you want to scan everything around you.
The “glow” can penetrate clothes and paper, so a magical ring in a pocket or a
magical pen underneath a sheet of paper can be detected.
