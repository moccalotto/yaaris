...
NOTE: A shield is also an armor piece.
...
<<Armor,armor pieces>> you are wearing takes damage and provides
one less _hit point_. You choose which armor piece takes damage.
Once an armor piece is reduced to zero hit points, it becomes
broken, which has two major side effects:
...
NOTE: If you're wearing a piece of broken armor that you're not
...
hp). You choose the shield, and mark it as providing only one zero hit point,
