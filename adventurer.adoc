...
__no higher__ than a specified __target number__, which is usually one of
your stats.
...
[[nat1,1]]
*Rolling a One*: Checks are always successful if you roll a 1 on your d20 and,
...
attack check has <<advantage>> because the orc is two or more levels above the
adventurer.
...
adventurer is two levels above the merchant.
