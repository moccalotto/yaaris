...
[horizontal]
Throwing Weapons:: The max range of throwing weapons is equal to your __strength__.
Projectile Weapons:: The max range of projectile weapons is equal to your __wisdom__.
****
...
The __stat__ for Heavy Unarmed Combat is __strength__.

[reftext="weapon's damage"]
[[attack_check_weapon_damage]]
*Weapon's Damage*: The base damage of the weapon depends on its type:
...
The __weapon damage__ for Heavy Unarmed Combat is 1.
...
| Roll      | Damage
//----------|----------------------------------------------------
| <<nat20>> | You miss, and your weapon <<weapon_wear,breaks>>
| Failure   | {weapon_damage}
| Success   | {roll} + {weapon_damage}
| <<nat1>>  | {stat} + {weapon_damage}
//----------|----------------------------------------------------
|===
...
| Failure   | The spell takes effect and the book loses all its <<usage_points>>.
