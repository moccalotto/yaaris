...
Total item slots:: is the maximum number of <<item_slots,items>> you can carry.
...
[quote]
You can target baddies who are 2·_wisdom_ meters away, but if they are more
than _wisdom_ meters away, the <<attack_and_damage,attack check>> is
<<difficult>>.
...
<<death_table>>.  + Baddies and NPCs also have hit points, and
