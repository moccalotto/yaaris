...
every time you gain a new level; armor and unused <<item_slots>> also increase
your number of hit points.
...
[quote]
You also gain one hit point for every <<unused_item_slot,unused item slot>> you
have.
...
* You can fight at full capacity until you're at death's door.
* You have an extremely high pain tolerance.
* You generally don't suffer from mundane illnesses and ailments such as the
  flu, ulcers, food poisoning, arthritis, bad teeth, and even cancers.
* You are almost immune to long-term effects of physical trauma such as
  brain damage, poorly healed bone fractures, and torn ligaments.
* You are almost immune to mental health problems such as anxiety and PTSD.
* You can be revived with magic (most other creatures can't).
...
ability to be revived can be vital, excuse the pun, for the continuation of the
position.
