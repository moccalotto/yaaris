...
.Cancelling a spell
****
A spell that has a given duration must run its course. It cannot be cancelled
unless it also has the <<focus>> property, or if it is explicitly allowed in
...
The spell lasts up to 3·<<X>> rounds, but stops earlier if you stop focusing on
it or if you dismount.
