...
spend 10 minutes and one <<consumption_check,consumption>> of _tinkering
tools_. Then you make a _dexterity_ check and an _intelligence_ check.
...
using tinkering tools alone; _medium_ and _heavy_ armor also requires a furnace
(or the <<_furnace>> spell).
...
_dexterity_ and _wisdom_ check.
