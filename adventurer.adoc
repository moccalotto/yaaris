...
stats). For instance: when rolling a strength check you roll a d20 and must
...
//KEY:
*Level, L*: A character can have a level between 1 and 10. Baddies, traps,
locks, spells, and various tasks can also have a level.

//KEY:
*NPC, NPCs*: Non player character(s). These persons and creatures are played
by the GM.
...
//KEY:
*Target Number, TN*: The number you must roll below (usually with your d20) in
