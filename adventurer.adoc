...
Unskilled Attacks:: If you are not skilled at using a weapon, the __attack
check__ is <<difficult>>.

Light Melee Weapons:: These weapons, except quarterstaves, are one-handed.

Heavy Melee Weapons:: Are always two-handed.

Projectile Weapons:: This type of ranged weapon, such as bows, crossbows, and
slings require ammunition and almost always require two hands.

Throwing Weapons:: This type of ranged weapons are usually one-handed, and some
of them (such as daggers and javelins) can also be used as light melee weapons.

Unarmed Combat:: requires two free hands, but does not suffer from
<<damaged_weapon,weapon wear and tear>>.
...
[%header,cols="6,^2,^2,^2"]
|===
| Weapon Type           | Stat        | Skill level | Damage Roll
//----------------------|-------------|-------------|-------------
...
|===
//----------|-------------------------------------
| <<nat20>> | You deal no damage and your weapon <<damaged_weapon,takes damage>>.
| Failure   | You deal half damage if you are <<weapon_skills,skilled>> with
              your weapon, otherwise you deal no damage.
...
==== Weapon Wear
If you roll a <<nat20>> on your attack check, your weapon can become damaged or
unusable.

[[damaged_weapon,damaged]]
*Damaged*: attacking with a damaged weapon is <<difficult>> and if you
roll a <<nat20>> on your attack check, your weapon becomes unusable.
...
check, the creature loses <<X>>d6+<<X>> <<hit_points>>, otherwise it loses
<<X>>d6 <<hit_points>>.
