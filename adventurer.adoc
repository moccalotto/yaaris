...
*Feed*: You can feed your horse animal feed, and if you can't you can feed it
with <<rations>>, but the horse eats so much that you will have to make two
...
[reftext="acquire"]
[[lvl_acquire]]
*Acquire*: You have __acquired__ a treasure when you have transported it
safely back to your base of operations. It can be necessary to make multiple
