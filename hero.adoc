...
=== Legendary Stats
No stat can ever be increased further than 15.

However, if you have a stat at 15 and you receive a stat increase (for instance
by levelling up) you gain a special ability instead. This can happen multiple
times.
...
*Heavy Lifter*:
You gain 2 extra {item_slots} and you have {advantage} on checks and rolls that
involve lifting stuff.

You can gain this ability multiple times; it increases the number of {item_slots}
gained by 2 each time.
...
*Brutal Strike*:
You can make an attack that deals maximum possible damage. You can do this {L}
times per day.

*Reckless Strength*:
Whenever you make a strength-based check you can choose to make it
__reckless__. A reckless check is {difficult}, but of you roll a four or lower
on your die, it is converted into a {one}, which is a guaranteed success as
well as an extraordinary success when it comes to attack checks.
...
possible value. You can do this {L} times per day.
...
effects. On top of that you also gain 5 extra hit points.
...
Your memory is extremely good; you can remember and recall practically
everything in great detail, from large scale geography down to individual
letters in texts you have read. You can even recall every single step you've
taken through a dungeon.

[quote]
You memory is not perfect; you can't recall stuff the GM can't either :-)
...
*Financier*:
You can more or less instantly determine the worth of a pile, bag, or pouch of
coins. You can also easily spot fake or worn-out coins. Very large piles of
coins may take you a little bit of time to count, but even at a glance you can
determine its rough value. It is more or less impossible to trick you with 
fake coins or other illicit schemes.
...
*Negotiator*:
You have {advantage} on checks that involve negotiation, interrogation, 
charm, and {haggling}. Moreover, once per day you can sell a single item for
...
*Curator*:
You can appraise valuable objects such as art pieces, gems, jewelry very 
fast and to a very high degree of accuracy. You have {advantage} on any
checks that involve the authenticity of a product, even if said check is not
a __charisma__ check.
...
==== Weapon Skills
You are only __skilled__ at using daggers and quarterstaffs. You are not
...
[[mages_spellbook]]
*Mage's spellbooks* are like basic spell books, but they can contain both
{basic} and <<mage>> spells. Mage's spellbooks are more efficient than
__basic{sp}spellbooks__, but they can only be used by mages.
...
.Rogue's Attack and Damage
[%header,cols="6,^2,^2,^2"]
|===
| Weapon                | Stat        | Skill       | Damage
//----------------------|-------------|-------------|-------------
| Light Melee Weapons   | _strength_  | Skilled     | 1d6
| Thrown Daggers        | _wisdom_    | Skilled     | 1d6
...
[quote,Bruno LeDique]
The warrior is fierce, tough, and dangerous.
